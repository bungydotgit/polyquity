...
- [x] Contracts: IdentityRegistry (KYC later), PolyFactory, PolyIPO, PolyToken (ERC20)
- [x] Issuer UI + Investor UI (wallet connection)
...
- [ ] Guardrails: only allow DRHP PDFs on IPFS
- [ ] IPO rank chart
- [ ] AI agent for IPO ranking & analysis (AI SDK / LangChain)
- [ ] KYC & AML (IdentityRegistry + World ID / Reclaim)
- [ ] Public testnet deployment (Avalanche Fuji)
